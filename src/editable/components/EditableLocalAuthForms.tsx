...
const inputClass = 'h-12 rounded-md border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-neutral-900 outline-none transition placeholder:text-neutral-400 focus:border-[#fb7a21] focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[#fb7a21] px-6 text-sm font-black uppercase text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
